...
export const Footer1 = () => {
  return (
    <div className="bg-color-fondo font-semibold bottom-0 px-4 pt-16 mx-auto md:px-24 lg:px-8 z-100">
      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2 mx-auto">
          ...
          <div className="mt-6 lg:max-w-sm">
            ...
            <p className="mt-4 text-sm text-color-letra-footer">
              Eaque ipsa quae ab illo inventore veritatis et quasi architecto
              beatae vitae dicta sunt explicabo.
            </p>
          </div>
        </div>
        <div className="space-y-2 text-sm mx-auto">
          ...
          <div className="flex">
            ...
            <Link
              ...
              title="Our address"
              className="ttransition-colors duration-300 text-color-letra-footer hover:text-color-letra-card"
            >
        ...
        <div className="mx-auto">
          ...
          <div className="flex items-center mt-1 space-x-3">
            <Link
              to="/"
              className="transition-colors duration-300 text-color-letra-footer hover:text-white"
            >
            ...
            <Link
              ...
              className="transition-colors duration-300 text-color-letra-footer hover:text-white"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-8src/components/footer.tsx">
